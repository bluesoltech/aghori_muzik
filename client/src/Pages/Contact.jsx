        ...
        <div className="container mx-auto  p-6 flex flex-wrap md:flex-nowrap">
          <div className="justify-center items-center w-full">
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
              ...
              <p className='text-[#2A304c] text-xl justify-center text-center'>We do fast phone repair. In most to repair your device in just minutes, li we’ll normally get con nection inutes, we’ll normally ge.</p>
              <div className="mb-4">
              ...
              <div className="mb-4">
                <label htmlFor="email" className="block text-gray-700 text-sm font-bold mb-2">Mobile Number</label>
                <input type="email" id="email" name="email" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required />
              </div>
              <div className="mb-4">
              ...
              <div className="flex items-center justify-between">
                <button className='text-sm font-semibold leading-6 text-white bg-gradient-to-r from-[#161928] to-[#4E598E] px-4 py-2 rounded-lg'>Send Our Message</button>
              </div>
            </form>
          </div>
