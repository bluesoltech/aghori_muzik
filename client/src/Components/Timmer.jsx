...
const Timmer = () => {
    ...
    const startCountDown = useCallback(() => {
        ...
        const countDownDate = new Date(
            ...
            customDate.getMonth(),
            customDate.getDate() + 28,
            customDate.getHours() + 18,
            customDate.getMinutes() + 5,
    ...
    return (
        <div className="flex flex-col md:flex-row justify-center items-center" style={{ backgroundImage: 'linear-gradient(to right, #161928 40%, #4E598E 100%)' }}>
